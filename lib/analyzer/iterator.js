...
var ___test = null; // TODO remove that
...
_types.CallExpression = {
  enter: function (n, p, c) {
    ...
    // require('../lib/log').warn(type, h.collectId(n.callee).ids); // TODO investigate this strange thing here : display very long list of ids.
