...
Context.prototype.isFunction = function(id) {
  ...
  if (id.type === 'Identifier') {
    ...
    // TODO this is a very common piece of code, we should move it to helpers.
    if (ref.length > 1)
...
Context.prototype.flxName = function(n) {
  ...
  return (n.id ? n.id.name : 'anonymous') + '-' + salt++;
}

Context.prototype.placeRupturePoint = function(cb, n, i, type) {
  var name = this.flxName(cb),
      rupturePoint = {
    name: name,
    type: type,
    cb: cb,
