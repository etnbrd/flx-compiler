...
describe('Linker', function() {
  it('should put a variable in scope, if used by only one fluxion', function() {
    ...
    assert.notEqual(ctx.flx[generateFluxionName('reply')].scope[varname], undefined);
  })
  ...
  it('should put a variable in scope, if used by at least two fluxion, but not modified', function() {
    ...
    assert.notEqual(ctx.flx[generateFluxionName('replyA')].scope[varname], undefined);
    assert.notEqual(ctx.flx[generateFluxionName('replyB')].scope[varname], undefined);
  })
  ...
  it('should put a variable in sync, if used and modified by at least two fluxion', function() {
    ...
    assert.notEqual(ctx.flx[generateFluxionName('replyA')].sync[varname], undefined);
    assert.notEqual(ctx.flx[generateFluxionName('replyB')].sync[varname], undefined);
  })
})
